...
class FifthPage extends React.Component{ 
    state={
        ...
        showPageNine: false,
        showPageTen : false,
        showPageEleven:false,
        showPageTwelve:false,
        showPageThirteen:false
    }
    getBank = (event) =>{
        this.setState({showPageFifth: false ,showPageThirteen: true}); 
    }
    getOther = (event) =>{
        this.setState({showPageFifth: false ,showPageTwelve: true}); 
    }
    getMed= (event) =>{
        this.setState({showPageFifth: false ,showPageEleven: true});
    }
    getDept= (event) =>{
    ...
    render(){
        ...
        <div className="ImageContainer">
           ...
           <Figure className="mainFigure" onClick={this.getBank}><Figure.Image src={Bank2} height={200} width={600}/><Figure.Caption style={{fontSize:40, color:"white"}}> Banks & Insurance</Figure.Caption></Figure>
           <Figure className="mainFigure" onClick={this.getMed}><Figure.Image src={Medical2} height={200} width={600}/><Figure.Caption style={{fontSize:40, color:"white"}}> Medical Services</Figure.Caption></Figure>
           <Figure className="mainFigure" onClick={this.getOther}><Figure.Image src={Other2} height={200} width={600}/><Figure.Caption style={{fontSize:40, color:"white"}}> Other businesses</Figure.Caption></Figure>
        ...
        <div>
            {this.state.showPageThirteen?<Thirteen/>:<span></span>}
            {this.state.showPageTwelve?<Twelve/>:<span></span>}
            {this.state.showPageEleven?<ElevenPage/>:<span></span>}
