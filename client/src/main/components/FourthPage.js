...
class FourthPage extends Component{
    ...
    addUser= async()=>{
        ...
        if(FullName==""||MemberID==""||UserName==""||Password==""){
          ...
          let fullnameExist =  await axios.post('/users/getFullName',{fullname:FullName});
          if(fullnameExist.data.length>0){
            ...
            let memberIDExist =  await axios.post('/users/getMemberID',{memberID:MemberID}); 
            ...
            let usernameExist =  await axios.post('/users/getUserName',{username:UserName}); 
        ...
        let response = await axios.post('/users/addUser',{FullName:FullName,MemberID:MemberID, UserName:UserName,Password:Password});
