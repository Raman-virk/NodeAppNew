...
class Reason extends Component {
    ...
    SaveReview = async() =>{
        ...
        let response =  await axios.post('http://localhost:5000/reviews/addReview',{Logo:this.state.logoName, Location:this.state.selectedLocation,Light:this.state.selectedLight,Reason:reasonValue,Username: this.state.User});
